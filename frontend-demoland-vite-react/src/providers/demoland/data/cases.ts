...
export const demoTimeline: TimelineEntry[] = [
  ...
  { date: '2025-10-28', event: 'Compliance Record: Initial Disclosures', type: 'attestation', status: 'completed' },
  ...
  { date: '2025-12-14', event: 'Compliance Record: DEF Production', type: 'attestation', status: 'completed' },
