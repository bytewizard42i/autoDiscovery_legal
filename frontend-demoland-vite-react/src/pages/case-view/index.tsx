...
export function CaseView() {
  ...
  const handleExportReport = async () => {
    ...
    const reportHtml = `
      ...
      <h2>Compliance Record History</h2>
      <table>
        <thead><tr><th>Type</th><th>Description</th><th>Verification ID</th><th>Timestamp</th><th>Verified</th></tr></thead>
      ...
      <div class="footer">
        <p>This report was generated by AutoDiscovery Legal Intelligence. Compliance records can be independently verified against the Midnight blockchain.</p>
    ...
    <div className="space-y-6">
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          {/* Row 2: Compliance Records + Production Tracker */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Recent Attestations */}
            <div className="bg-card border border-border rounded-xl p-5 space-y-4">
              <h3 className="font-semibold flex items-center gap-2">
                <Shield className="w-4 h-4 text-primary" /> Compliance Records
              </h3>
